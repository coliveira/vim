...
an 50.10.110 &Syntax.AB.ABC :cal SetSyn("abc")<CR>
an 50.10.120 &Syntax.AB.ABEL :cal SetSyn("abel")<CR>
an 50.10.130 &Syntax.AB.Ada :cal SetSyn("ada")<CR>
an 50.10.140 &Syntax.AB.Aflex :cal SetSyn("aflex")<CR>
an 50.10.150 &Syntax.AB.AHDL :cal SetSyn("ahdl")<CR>
an 50.10.160 &Syntax.AB.Amiga\ DOS :cal SetSyn("amiga")<CR>
an 50.10.170 &Syntax.AB.Ant :cal SetSyn("ant")<CR>
an 50.10.180 &Syntax.AB.Antlr :cal SetSyn("antlr")<CR>
an 50.10.190 &Syntax.AB.Apache\ config :cal SetSyn("apache")<CR>
an 50.10.200 &Syntax.AB.Apache-style\ config :cal SetSyn("apachestyle")<CR>
an 50.10.210 &Syntax.AB.Applix\ ELF :cal SetSyn("elf")<CR>
an 50.10.220 &Syntax.AB.Arc\ Macro\ Language :cal SetSyn("aml")<CR>
an 50.10.230 &Syntax.AB.ASP\ with\ VBSages :cal SetSyn("aspvbs")<CR>
an 50.10.240 &Syntax.AB.ASP\ with\ Perl :cal SetSyn("aspperl")<CR>
an 50.10.250 &Syntax.AB.Assembly.680x0 :cal SetSyn("asm68k")<CR>
an 50.10.260 &Syntax.AB.Assembly.GNU :cal SetSyn("asm")<CR>
an 50.10.270 &Syntax.AB.Assembly.H8300 :cal SetSyn("asmh8300")<CR>
an 50.10.280 &Syntax.AB.Assembly.Intel\ Itanium :cal SetSyn("ia64")<CR>
an 50.10.290 &Syntax.AB.Assembly.Microsoft :cal SetSyn("masm")<CR>
an 50.10.300 &Syntax.AB.Assembly.Netwide :cal SetSyn("nasm")<CR>
an 50.10.310 &Syntax.AB.Assembly.PIC :cal SetSyn("pic")<CR>
an 50.10.320 &Syntax.AB.Assembly.Turbo :cal SetSyn("tasm")<CR>
an 50.10.330 &Syntax.AB.Assembly.Z-80 :cal SetSyn("z8a")<CR>
an 50.10.340 &Syntax.AB.ASN\.1 :cal SetSyn("asn")<CR>
an 50.10.350 &Syntax.AB.Atlas :cal SetSyn("atlas")<CR>
an 50.10.360 &Syntax.AB.Automake :cal SetSyn("automake")<CR>
an 50.10.370 &Syntax.AB.Avenue :cal SetSyn("ave")<CR>
an 50.10.380 &Syntax.AB.Awk :cal SetSyn("awk")<CR>
an 50.10.390 &Syntax.AB.Ayacc :cal SetSyn("ayacc")<CR>
an 50.10.410 &Syntax.AB.B :cal SetSyn("b")<CR>
an 50.10.420 &Syntax.AB.Baan :cal SetSyn("baan")<CR>
an 50.10.430 &Syntax.AB.BASIC :cal SetSyn("basic")<CR>
an 50.10.440 &Syntax.AB.BC\ calculator :cal SetSyn("bc")<CR>
an 50.10.450 &Syntax.AB.BDF\ font :cal SetSyn("bdf")<CR>
an 50.10.460 &Syntax.AB.BibFile :cal SetSyn("bib")<CR>
an 50.10.470 &Syntax.AB.BIND\ configuration :cal SetSyn("named")<CR>
an 50.10.480 &Syntax.AB.BIND\ zone :cal SetSyn("bindzone")<CR>
an 50.10.490 &Syntax.AB.Blank :cal SetSyn("blank")<CR>
an 50.20.100 &Syntax.CD.C :cal SetSyn("c")<CR>
an 50.20.110 &Syntax.CD.C++ :cal SetSyn("cpp")<CR>
an 50.20.120 &Syntax.CD.Crontab :cal SetSyn("crontab")<CR>
an 50.20.130 &Syntax.CD.Cyn++ :cal SetSyn("cynpp")<CR>
an 50.20.140 &Syntax.CD.Cynlib :cal SetSyn("cynlib")<CR>
an 50.20.150 &Syntax.CD.Cascading\ Style\ Sheets :cal SetSyn("css")<CR>
an 50.20.160 &Syntax.CD.Century\ Term :cal SetSyn("cterm")<CR>
an 50.20.170 &Syntax.CD.CFG :cal SetSyn("cfg")<CR>
an 50.20.180 &Syntax.CD.CHILL :cal SetSyn("ch")<CR>
an 50.20.190 &Syntax.CD.Change :cal SetSyn("change")<CR>
...
an 50.20.250 &Syntax.CD.Configure\ script :cal SetSyn("config")<CR>
an 50.20.260 &Syntax.CD.Csh\ shell\ script :cal SetSyn("csh")<CR>
an 50.20.270 &Syntax.CD.Ctrl-H :cal SetSyn("ctrlh")<CR>
an 50.20.280 &Syntax.CD.Cobol :cal SetSyn("cobol")<CR>
an 50.20.290 &Syntax.CD.CSP :cal SetSyn("csp")<CR>
an 50.20.300 &Syntax.CD.CUPL.CUPL :cal SetSyn("cupl")<CR>
an 50.20.310 &Syntax.CD.CUPL.simulation :cal SetSyn("cuplsim")<CR>
an 50.20.320 &Syntax.CD.CVS\ commit :cal SetSyn("cvs")<CR>
an 50.20.330 &Syntax.CD.CWEB :cal SetSyn("cweb")<CR>
...
an 50.20.390 &Syntax.CD.Diva\ (with\ SKILL) :cal SetSyn("diva")<CR>
an 50.20.400 &Syntax.CD.DNS :cal SetSyn("dns")<CR>
an 50.20.410 &Syntax.CD.DOT :cal SetSyn("dto")<CR>
...
an 50.20.470 &Syntax.CD.Dylan.Dylan\ intr :cal SetSyn("dylanintr")<CR>
an 50.20.480 &Syntax.CD.Dylan.Dylan\ lid :cal SetSyn("dylanlid")<CR>
an 50.30.100 &Syntax.EFG.Eiffel :cal SetSyn("eiffel")<CR>
an 50.30.110 &Syntax.EFG.Elm\ Filter :cal SetSyn("elmfilt")<CR>
...
an 50.30.150 &Syntax.EFG.Eterm\ config :cal SetSyn("eterm")<CR>
an 50.30.160 &Syntax.EFG.Expect :cal SetSyn("expect")<CR>
an 50.30.170 &Syntax.EFG.Exports :cal SetSyn("exports")<CR>
an 50.30.190 &Syntax.EFG.Focus\ Executable :cal SetSyn("focexec")<CR>
an 50.30.200 &Syntax.EFG.Focus\ Master :cal SetSyn("master")<CR>
an 50.30.210 &Syntax.EFG.FORM :cal SetSyn("form")<CR>
an 50.30.220 &Syntax.EFG.Forth :cal SetSyn("forth")<CR>
an 50.30.230 &Syntax.EFG.Fortran :cal SetSyn("fortran")<CR>
an 50.30.240 &Syntax.EFG.FoxPro :cal SetSyn("foxpro")<CR>
an 50.30.250 &Syntax.EFG.Fvwm\ configuration :cal SetSyn("fvwm1")<CR>
an 50.30.260 &Syntax.EFG.Fvwm2\ configuration :cal SetSyn("fvwm2")<CR>
an 50.30.280 &Syntax.EFG.GDB\ command\ file :cal SetSyn("gdb")<CR>
an 50.30.290 &Syntax.EFG.GDMO :cal SetSyn("gdmo")<CR>
an 50.30.300 &Syntax.EFG.Gedcom :cal SetSyn("gedcom")<CR>
an 50.30.310 &Syntax.EFG.GP :cal SetSyn("gp")<CR>
an 50.30.320 &Syntax.EFG.GNU\ Server\ Pages :cal SetSyn("gsp")<CR>
an 50.30.330 &Syntax.EFG.GNUplot :cal SetSyn("gnuplot")<CR>
an 50.30.340 &Syntax.EFG.GTKrc :cal SetSyn("gtkrc")<CR>
...
an 50.40.260 &Syntax.HIJK.InstallShield\ Rules :cal SetSyn("ishd")<CR>
...
an 50.50.110 &Syntax.L-Ma.Lamda\ Prolog :cal SetSyn("lprolog")<CR>
an 50.50.120 &Syntax.L-Ma.Latte :cal SetSyn("latte")<CR>
an 50.50.130 &Syntax.L-Ma.Lex :cal SetSyn("lex")<CR>
an 50.50.140 &Syntax.L-Ma.LFTP :cal SetSyn("lftp")<CR>
an 50.50.150 &Syntax.L-Ma.Lilo :cal SetSyn("lilo")<CR>
an 50.50.160 &Syntax.L-Ma.Lisp :cal SetSyn("lisp")<CR>
an 50.50.170 &Syntax.L-Ma.Lite :cal SetSyn("lite")<CR>
an 50.50.180 &Syntax.L-Ma.LOTOS :cal SetSyn("lotos")<CR>
an 50.50.190 &Syntax.L-Ma.LotusScript :cal SetSyn("lscript")<CR>
an 50.50.200 &Syntax.L-Ma.Lout :cal SetSyn("lout")<CR>
an 50.50.210 &Syntax.L-Ma.Lua :cal SetSyn("lua")<CR>
an 50.50.220 &Syntax.L-Ma.Lynx\ Style :cal SetSyn("lss")<CR>
an 50.50.230 &Syntax.L-Ma.Lynx\ config :cal SetSyn("lynx")<CR>
an 50.50.250 &Syntax.L-Ma.M4 :cal SetSyn("m4")<CR>
an 50.50.260 &Syntax.L-Ma.MaGic\ Point :cal SetSyn("mgp")<CR>
an 50.50.270 &Syntax.L-Ma.Mail :cal SetSyn("mail")<CR>
an 50.50.280 &Syntax.L-Ma.Makefile :cal SetSyn("make")<CR>
an 50.50.290 &Syntax.L-Ma.MakeIndex :cal SetSyn("ist")<CR>
an 50.50.300 &Syntax.L-Ma.Man\ page :cal SetSyn("man")<CR>
an 50.50.310 &Syntax.L-Ma.Maple :cal SetSyn("maple")<CR>
an 50.50.320 &Syntax.L-Ma.Mason :cal SetSyn("mason")<CR>
an 50.50.330 &Syntax.L-Ma.Mathematica :cal SetSyn("mma")<CR>
an 50.50.340 &Syntax.L-Ma.Matlab :cal SetSyn("matlab")<CR>
...
an 50.60.130 &Syntax.Me-NO.MS\ Module\ Definition :cal SetSyn("def")<CR>
...
an 50.60.190 &Syntax.Me-NO.Msql :cal SetSyn("msql")<CR>
an 50.60.200 &Syntax.Me-NO.MS-DOS.MS-DOS\ \.bat\ file :cal SetSyn("dosbatch")<CR>
an 50.60.210 &Syntax.Me-NO.MS-DOS.4DOS\ \.bat\ file :cal SetSyn("btm")<CR>
an 50.60.220 &Syntax.Me-NO.MS-DOS.MS-DOS\ \.ini\ file :cal SetSyn("dosini")<CR>
an 50.60.230 &Syntax.Me-NO.MS\ Resource\ file :cal SetSyn("rc")<CR>
an 50.60.240 &Syntax.Me-NO.Mush :cal SetSyn("mush")<CR>
an 50.60.250 &Syntax.Me-NO.Muttrc :cal SetSyn("muttrc")<CR>
an 50.60.270 &Syntax.Me-NO.Nastran\ input/DMAP :cal SetSyn("nastran")<CR>
an 50.60.280 &Syntax.Me-NO.Natural :cal SetSyn("natural")<CR>
an 50.60.290 &Syntax.Me-NO.Novell\ batch :cal SetSyn("ncf")<CR>
an 50.60.300 &Syntax.Me-NO.Not\ Quite\ C :cal SetSyn("nqc")<CR>
an 50.60.310 &Syntax.Me-NO.Nroff :cal SetSyn("nroff")<CR>
an 50.60.330 &Syntax.Me-NO.Objective\ C :cal SetSyn("objc")<CR>
an 50.60.340 &Syntax.Me-NO.OCAML :cal SetSyn("ocaml")<CR>
an 50.60.350 &Syntax.Me-NO.Omnimark :cal SetSyn("omnimark")<CR>
an 50.60.360 &Syntax.Me-NO.OpenROAD :cal SetSyn("openroad")<CR>
an 50.60.370 &Syntax.Me-NO.Open\ Psion\ Lang :cal SetSyn("opl")<CR>
an 50.60.380 &Syntax.Me-NO.Oracle\ config :cal SetSyn("ora")<CR>
...
an 50.70.190 &Syntax.PQ.Phtml :cal SetSyn("phtml")<CR>
...
an 50.70.280 &Syntax.PQ.Povray :cal SetSyn("pov")<CR>
...
an 50.80.160 &Syntax.R-Sg.Registry\ of\ MS-Windows :cal SetSyn("registry")<CR>
an 50.80.170 &Syntax.R-Sg.Remind :cal SetSyn("remind")<CR>
an 50.80.180 &Syntax.R-Sg.Renderman\ Shader\ Lang :cal SetSyn("sl")<CR>
an 50.80.190 &Syntax.R-Sg.Rexx :cal SetSyn("rexx")<CR>
an 50.80.200 &Syntax.R-Sg.Robots\.txt :cal SetSyn("robots")<CR>
...
an 50.80.300 &Syntax.R-Sg.Screen\ RC :cal SetSyn("screen")<CR>
an 50.80.310 &Syntax.R-Sg.SDL :cal SetSyn("sdl")<CR>
an 50.80.320 &Syntax.R-Sg.Sed :cal SetSyn("sed")<CR>
an 50.80.330 &Syntax.R-Sg.Sendmail\.cf :cal SetSyn("sm")<CR>
an 50.80.340 &Syntax.R-Sg.SGML.SGML\ catalog :cal SetSyn("catalog")<CR>
an 50.80.350 &Syntax.R-Sg.SGML.SGML\ DTD :cal SetSyn("sgml")<CR>
an 50.80.360 &Syntax.R-Sg.SGML.SGML\ Declarations :cal SetSyn("sgmldecl")<CR>
an 50.80.370 &Syntax.R-Sg.SGML.SGML\ linuxdoc :cal SetSyn("sgmllnx")<CR>
an 50.90.100 &Syntax.Sh-S.Sh\ shell\ script :cal SetSyn("sh")<CR>
an 50.90.110 &Syntax.Sh-S.SiCAD :cal SetSyn("sicad")<CR>
an 50.90.120 &Syntax.Sh-S.Simula :cal SetSyn("simula")<CR>
an 50.90.130 &Syntax.Sh-S.Sinda.Sinda\ compare :cal SetSyn("sindacmp")<CR>
an 50.90.140 &Syntax.Sh-S.Sinda.Sinda\ input :cal SetSyn("sinda")<CR>
an 50.90.150 &Syntax.Sh-S.Sinda.Sinda\ output :cal SetSyn("sindaout")<CR>
an 50.90.160 &Syntax.Sh-S.SKILL :cal SetSyn("skill")<CR>
an 50.90.170 &Syntax.Sh-S.SLRN.SLRN\ rc :cal SetSyn("slrnrc")<CR>
an 50.90.180 &Syntax.Sh-S.SLRN.SLRN\ score :cal SetSyn("slrnsc")<CR>
an 50.90.190 &Syntax.Sh-S.SmallTalk :cal SetSyn("st")<CR>
an 50.90.200 &Syntax.Sh-S.SMIL :cal SetSyn("smil")<CR>
an 50.90.210 &Syntax.Sh-S.SMITH :cal SetSyn("smith")<CR>
an 50.90.220 &Syntax.Sh-S.SNMP\ MIB :cal SetSyn("mib")<CR>
an 50.90.230 &Syntax.Sh-S.SNNS.SNNS\ network :cal SetSyn("snnsnet")<CR>
an 50.90.240 &Syntax.Sh-S.SNNS.SNNS\ pattern :cal SetSyn("snnspat")<CR>
an 50.90.250 &Syntax.Sh-S.SNNS.SNNS\ result :cal SetSyn("snnsres")<CR>
an 50.90.260 &Syntax.Sh-S.Snobol4 :cal SetSyn("snobol4")<CR>
an 50.90.270 &Syntax.Sh-S.Snort\ Configuration :cal SetSyn("hog")<CR>
an 50.90.280 &Syntax.Sh-S.SPEC\ (Linux\ RPM) :cal SetSyn("spec")<CR>
an 50.90.290 &Syntax.Sh-S.Specman :cal SetSyn("specman")<CR>
an 50.90.300 &Syntax.Sh-S.Spice :cal SetSyn("spice")<CR>
an 50.90.310 &Syntax.Sh-S.Speedup :cal SetSyn("spup")<CR>
an 50.90.320 &Syntax.Sh-S.Splint :cal SetSyn("splint")<CR>
an 50.90.330 &Syntax.Sh-S.Squid :cal SetSyn("squid")<CR>
an 50.90.340 &Syntax.Sh-S.SQL :cal SetSyn("sql")<CR>
an 50.90.350 &Syntax.Sh-S.SQL\ Forms :cal SetSyn("sqlforms")<CR>
an 50.90.360 &Syntax.Sh-S.SQR :cal SetSyn("sqr")<CR>
an 50.90.370 &Syntax.Sh-S.Standard\ ML :cal SetSyn("sml")<CR>
an 50.90.380 &Syntax.Sh-S.Stored\ Procedures :cal SetSyn("stp")<CR>
an 50.90.390 &Syntax.Sh-S.Strace :cal SetSyn("strace")<CR>
an 50.100.100 &Syntax.TUV.Tads :cal SetSyn("tads")<CR>
an 50.100.110 &Syntax.TUV.Tags :cal SetSyn("tags")<CR>
an 50.100.120 &Syntax.TUV.TAK.TAK\ compare :cal SetSyn("tak")<CR>
...
an 50.100.180 &Syntax.TUV.Termcap :cal SetSyn("ptcap")<CR>
an 50.100.190 &Syntax.TUV.Terminfo :cal SetSyn("terminfo")<CR>
an 50.100.200 &Syntax.TUV.TeX :cal SetSyn("tex")<CR>
an 50.100.210 &Syntax.TUV.TeX\ configuration :cal SetSyn("texmf")<CR>
an 50.100.220 &Syntax.TUV.Texinfo :cal SetSyn("texinfo")<CR>
...
an 50.100.390 &Syntax.TUV.Virata :cal SetSyn("virata")<CR>
...
an 50.110.100 &Syntax.WXYZ.WEB :cal SetSyn("web")<CR>
an 50.110.110 &Syntax.WXYZ.Webmacro :cal SetSyn("webmacro")<CR>
an 50.110.120 &Syntax.WXYZ.Website\ MetaLanguage :cal SetSyn("wml")<CR>
an 50.110.130 &Syntax.WXYZ.Wdiff :cal SetSyn("wdiff")<CR>
an 50.110.140 &Syntax.WXYZ.Wget\ config :cal SetSyn("wget")<CR>
an 50.110.150 &Syntax.WXYZ.Whitespace\ (add) :cal SetSyn("whitespace")<CR>
an 50.110.160 &Syntax.WXYZ.WinBatch/Webbatch :cal SetSyn("winbatch")<CR>
an 50.110.170 &Syntax.WXYZ.Windows\ Scripting\ Host :cal SetSyn("wsh")<CR>
an 50.110.180 &Syntax.WXYZ.WvDial :cal SetSyn("wvdial")<CR>
an 50.110.200 &Syntax.WXYZ.X\ Keyboard\ Extension :cal SetSyn("xkb")<CR>
an 50.110.210 &Syntax.WXYZ.X\ Pixmap :cal SetSyn("xpm")<CR>
an 50.110.220 &Syntax.WXYZ.X\ Pixmap\ (2) :cal SetSyn("xpm2")<CR>
an 50.110.230 &Syntax.WXYZ.X\ resources :cal SetSyn("xdefaults")<CR>
an 50.110.240 &Syntax.WXYZ.Xmath :cal SetSyn("xmath")<CR>
an 50.110.250 &Syntax.WXYZ.XML :cal SetSyn("xml")<CR>
an 50.110.260 &Syntax.WXYZ.Xslt :cal SetSyn("xslt")<CR>
an 50.110.270 &Syntax.WXYZ.XXD\ hex\ dump :cal SetSyn("xxd")<CR>
an 50.110.290 &Syntax.WXYZ.Yacc :cal SetSyn("yacc")<CR>
an 50.110.310 &Syntax.WXYZ.Zsh\ shell\ script :cal SetSyn("zsh")<CR>
